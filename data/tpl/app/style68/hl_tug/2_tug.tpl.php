...
function  updata(){
	<?php  if($whoteam) { ?>
	if(last_count<=count){
		$.post("<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=hl_tug&id=<?php  echo $id;?>&do=postjson&r="+new Date().getTime(), {fromuser: "<?php  echo $fromuser;?>",  ucount: count }, function(result){
			result = eval("(" + result + ")");
...
function getstartime(){
	 $.get("<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&m=hl_tug&id=<?php  echo $id;?>&do=startime&r="+new Date().getTime(),function(data,status){
		//alert("Data: " + data + "\nStatus: " + status);
...
<div class="index">
    ...
    <div class="container">
        ...
        <div class="cont-team">
            ...
            <div class="teamline">
                <span class="<?php  if($whoteam==1) { ?>team-red<?php  } else { ?>team-blue<?php  } ?>">
                	<img src="<?php  if($whoteam==1) { ?><?php  echo $_W['attachurl'];?><?php  echo $reply['teamapic'];?><?php  } else { ?><?php  echo $_W['attachurl'];?><?php  echo $reply['teambpic'];?><?php  } ?>">
                    <p><?php  if($whoteam==1) { ?><?php  echo $reply['teama'];?><?php  } else { ?><?php  echo $reply['teamb'];?><?php  } ?></p>
                </span>
            </div>
            <div class="cont-txt">
                <p>
    ...
    <div class="result-box">
    	<ul class="clearfix">
        	<li>
                ...
                <span class="rst-right"><?php  if($whoteam==1) { ?><?php  echo $reply['teama'];?><?php  } else { ?><?php  echo $reply['teamb'];?><?php  } ?></span>
            </li>
            <li>
