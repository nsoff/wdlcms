...
<head>
	...
	<title><?php  echo $zzz['title'];?></title>
	...
	<script type="text/javascript">
		...
		var introduceDes = "<?php  echo $zzz['smallunit'];?>";
		var helpDes = "<?php  echo $zzz['title'];?>，抢头等奖。快进来助我一臂之力～～";
		var rankingDes = "<?php  echo $zzz['title'];?>，前十名能拿到粽子哦~你也来吧！~~";
...
<div class="page-load-container">
	<div class="page-load-page index-page" data-id="indexPage" data-double="false" data-energycost="10" data-energylimit="<?php  echo $energylimit;?>">
		<div class="nav-type2 " onclick="pageLoad.changePage('<?php  echo $this->createMobileUrl('rank', array('id' => $id))?>', false, false)">
			<div class="user-head ellipsis"><?php  echo $profile['nickname'];?> :</div>
			<div class="gather-ranking">
				<div class="gr-c1">
					<div class="gather">
						<span class="gather-icon1">总<?php  echo $zzz['smallunit'];?></span>
					</div>
				...
				<div class="gr-c2">
					<div class="ranking">
						<span class="ranking-icon1">可做<?php  echo $zzz['bigunit'];?></span>
					</div>
				...
				<div class="gr-c2">
					...
					<div class="ranking week">
						<span class="ranking-num" id="rankingNum"><?php  echo $myph;?></span>
					</div>
				</div>
		...
		<div class="index-body">
			...
			<div class="index-power-buttons">
				<?php  if($startgame) { ?>
				<div class="index-power-button" id="powerButton" onclick="HL.COMMON.powerClick(this);">上一把<?php  echo $zzz['smallunit'];?></div>
				<?php  } else { ?>
				<div class="index-power-button" id="powerButton" ><?php  echo $str;?></div>
				<?php  } ?>
			</div>
		...
		<div class="table index-buttons">
			<div class="tr">
				...
				<a data-page="false" data-ajax="false" class="td b2 index-button" href="<?php  echo $zzz['guzhuurl'];?>"><i class="icon index-introduce-icon"></i>我也要玩</a>
...
<script type="text/javascript">
	...
	wx.ready(function () {
		sharedata = {
			...
			link: "<?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('lottery', array('id' => $id, 'uid' => $myuser['id'], 'shareuid' => $_W['fans']['fanid']))?>",
