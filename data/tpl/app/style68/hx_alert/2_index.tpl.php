...
<head>
   ...
   <title><?php  echo $reply['title'];?>制作器</title>
   <link href="<?php  echo $_W['siteroot'];?>/addons/hx_alert/template/style/css/main.min.css" rel="stylesheet" type="text/css">
   <script src="<?php  echo $_W['siteroot'];?>/addons/hx_alert/template/style/js/main.m.js"></script>
   <script src="<?php  echo $_W['siteroot'];?>/addons/hx_alert/template/style/js/wxtools.min.js"></script>
</head>
...
.sbg .arron {
   ...
   width: 100px;
   height: 100px;
   background: url(<?php  echo $_W['siteroot'];?>addons/hx_alert/template/style/img/arron.gif) no-repeat;
...
.sbg .strong{
   ...
   <script>var _host = "http://" + window.location.host;
function attention_wx()
{
   //alert("关注微信“整蛊专家”，朋友圈整人利器！更多朋友圈整人游戏等你来玩！");
   location.href='<?php  echo $reply['gzurl'];?>';
}
function attention_wx2()
{
   //alert("关注微信“整蛊之霸”，发现身边小伙伴的小心思！进阶的整人指南！");
   location.href='<?php  echo $reply['gzurl'];?>';
}
var dataForWeixin = {
      appId : "",
      MsgImg : "<?php  echo $_W['attachurl'];?><?php  echo $reply['picture'];?>",
      TLImg : "<?php  echo $_W['attachurl'];?><?php  echo $reply['picture'];?>",
      shareurl : "<?php  echo $_W['siteurl'];?>",
...
var _model={
   ...
   _ok:function(json){
      _mid = json.mid;
      console.log(_mid);
      dataForWeixin.title = _title;
      dataForWeixin.shareurl = "<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['weid'];?>&c=entry&do=alert&m=hx_alert&mid=" + _mid;
