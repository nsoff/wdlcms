		...
		<div class="jumbotron clearfix alert alert-success" style="width:80%;margin:0 auto;margin-top:100px;">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
										<h2></h2>
					<p><?php  echo $resText;?></p>
															<p><a href="<?php  echo $this->createMobileUrl('Auth',array('id'=>$share['id'],"uid"=>$shareUser['id'],"au"=>1))?>">如果你的浏览器没有自动跳转，请点击此链接</a></p>
					<script type="text/javascript">
						setTimeout(function () {
							location.href = "<?php  echo $this->createMobileUrl('Auth',array('id'=>$share['id'],"uid"=>$shareUser['id'],"au"=>1))?>";
						}, 3000);
					</script>
									</div>
			</div>
