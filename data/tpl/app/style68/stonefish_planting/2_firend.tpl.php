...
<div class="wrap" ontouchmove="event.preventDefault()">
	...
	<div class="mask_day mask_d<?php  echo $seednum;?>"></div>
	<!-- 0~4次 -->
	<div class="rain rain_<?php  if($seednum<=4) { ?>1<?php  } else { ?>2<?php  } ?> none">
		<img src="../addons/stonefish_planting/template/images/rain_<?php  echo $seednum;?>.png" class="rainline">
	</div>
	<div class="waterpoint waterpoint_<?php  echo $seednum;?>">
	...
	<img src="../addons/stonefish_planting/template/images/cloud_1.png" class="spirit cloud_touch zhiyin<?php  if($haswatered==0) { ?> none<?php  } ?>">
	<?php  if($haswatered==0) { ?><img src="../addons/stonefish_planting/template/images/cloud_1.png" id="zhiyin" class="spirit cloud_touch cloud_animate"><?php  } ?>
	<div class="cloud_mask" id="cloud_touch"></div>
	<?php  if($haswatered==0) { ?><img src="<?php  echo $seedimg0;?>" class="spirit tree tree_0" id ="tree_0" style="opacity:1;"><?php  } ?>
	<img src="<?php  echo $seedimg;?>" class="spirit tree tree_<?php  echo $seednum;?><?php  if($haswatered==0) { ?> none<?php  } ?>" id ="tree_1" style="opacity:1;">
	<?php  if($seednum<7) { ?><img src="<?php  echo $seedimg1;?>" class="spirit tree tree_<?php  echo $seednum+1?>" style="opacity:0;"><?php  } ?>
	<div class="tree_shine shine_<?php  echo $seednum;?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine1<?php  if($haswatered==0) { ?> none<?php  } ?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine2<?php  if($haswatered==0) { ?> none<?php  } ?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine3<?php  if($haswatered==0) { ?> none<?php  } ?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine4<?php  if($haswatered==0) { ?> none<?php  } ?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine5<?php  if($haswatered==0) { ?> none<?php  } ?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine6<?php  if($haswatered==0) { ?> none<?php  } ?>">
		<img src="../addons/stonefish_planting/template/images/shine.png" class="shine7<?php  if($haswatered==0) { ?> none<?php  } ?>">
	</div>
	...
	<div class="jifen">
		...
		<span class="num">
		    <?php  if($haswatered==0) { ?><span><img src="../addons/stonefish_planting/template/images/num_1.png" alt=""></span>
		    ...
		    <span><img src="../addons/stonefish_planting/template/images/num_5.png" alt=""></span><?php  } ?>
		<span>
	</div>
	<?php  if($haswatered==0) { ?>
	...
	<a href="<?php  echo $this->createMobileUrl('index',array('rid'=>$rid,'from_user'=>$page_from_user))?>"><img src="../addons/stonefish_planting/template/images/<?php  echo $firendExistsimg;?>.png" class="btn_rule"></a>
</div>
...
<script type="text/javascript">
	var waterday = <?php  echo $seednum;?>;
	var htmlpath = '../addons/stonefish_planting/template/';
	var clickEvent = 'touchstart';
	var haswatered = <?php  echo $haswatered;?>;
	var rainInterval = '';
    var infoInterval = '';
    var canTouch = true;
	var shengzhang = 0;
	var showinfopng = <?php  echo $showinfopng;?>;
	$(function() {
	    if(<?php  echo $haswatered;?> == 0){
			zhiyinEvent();
        }else{
		...
		$('.zhiyin').bind("touchend",function(){
			$.ajax({type: "POST",url:"<?php  echo $this->createMobileUrl('FirendFanpai',array('rid'=>$rid,'uid'=>$fans['id']))?>",data: {fopenid: "<?php  echo $firend['openid'];?>",fnickname: "<?php  echo $firend['nickname'];?>",fheadUrl:"<?php  echo $firend['headimgurl'];?>"},dataType: "json",async: true,timeout: 3000,success: function(data) {
				if(data.code==200){
    ...
    function setJifenAnimate(num){
        var _start = 0;
        if(String(<?php  echo $sharenum;?>).length == String(num).length){
            if(String(<?php  echo $sharenum;?>)[0] == String(num)[0]){
                _start = 1;
            }
        }
    ...
    function addJifen(){//增加当前积分
        ...
        //var _jifen = _jifenArr[waterday] + <?php  echo $sharenum;?>;
		var _jifen = 1 + <?php  echo $sharenum;?>;
