...
<div class="head">
	...
	<span class="title">
		...
		<?php  if(!empty($_GPC['keyword'])) { ?>搜索结果<?php  } ?>
	...
	<ul class="unstyled order hide">
		...
		<li>
			<a href="<?php  echo $this->createMobileUrl('list2', array('pcate' => $item['id']))?>" class="bigtype">
				<i class="fa fa-folder-open"></i>  <?php  echo $item['name'];?>
			</a>
			...
			<a href="<?php  echo $this->createMobileUrl('list2', array('ccate' => $child['id']))?>" class="smtype">
				<i class="fa fa-folder"></i> <?php  echo $child['name'];?>
			</a>
			<?php  } } ?>
		</li>
		<?php  } } ?>
...
<div class="list-item img-rounded">
	<div>
		...
		<span class="title">
			...
			<strong style="color: #b0b8bd; text-decoration: line-through;">￥<?php  echo $item['originalprice'];?></strong>
		</span>
