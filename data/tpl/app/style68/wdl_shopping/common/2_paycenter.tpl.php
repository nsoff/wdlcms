...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom:0;">
	...
	<?php  if($pay['delivery']['switch']) { ?><li data-id="delivery"><a href="#collect" role="tab" data-toggle="tab">货到付款</a></li><?php  } ?>
	<!--li><a href="#">微动力担保</a></li-->
</ul>
			...
			<div class="alert alert-info">
				<div class="row text-center">
					<div class="col-xs-4">
						...
						<div class="help-block">付款给微动力</div>
					</div>
					<div class="col-xs-4">
						<span class="fa-stack fa-2x">
							<i class="fa fa-adjust fa-stack-2x"></i>
					...
					<div class="col-xs-4">
						...
						<div class="help-block">微动力付款给商家</div>
					</div>
				</div>
			</div>
