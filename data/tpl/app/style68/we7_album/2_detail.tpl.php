<?php defined('IN_IA') or exit('Access Denied');?><?php  $main_off = 1;?>
...
<?php  if($album['type'] == 1) { ?>
<script type="text/javascript" src="../addons/we7_album/template/mobile/360view.js"></script>
<style>
...
<script type="text/javascript">
	if (ggHasHtml5Css3D() || ggHasWebGL()) {
		...
		pano.readConfigUrl('<?php  echo $_W['siteroot'];?><?php  echo $url;?>&gettype=xml');
	} else{
...
<script type="text/javascript" src="../addons/we7_album/template/mobile/klass.min.js"></script>
<script type="text/javascript" src="../addons/we7_album/template/mobile/code.photoswipe.min.js"></script>
<script type="text/javascript" src="../addons/we7_album/template/mobile/jquery.lazyload.js"></script>
...
<div id="photo" style='height:auto'>
	...
	<div class="show-more"><a href="javascript:;" id="loadRecPage" class="img-rounded pager">显示更多</a></div>
</div>
...
<script type="text/javascript">
	$(function(){
		...
		var pindex = 1;
		$('#loadRecPage').click(function(){
			pindex = parseInt(pindex) + 1;
			var pager = $('.pager');
			pager.html('正在加载数据...');
			var url = "<?php  echo $this->createMobileUrl('detailmore')?>";
			$.get(url, {'page': pindex, 'id': '<?php  echo $id;?>'}, function(html){
