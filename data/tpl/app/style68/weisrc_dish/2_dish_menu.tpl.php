...
<style>
    ...
    .group_checkbox input[type="checkbox"]{
        ...
        display:inline-block;
        height:35px;
        background:url(../addons/weisrc_dish/template/images/btn1.png#1), -webkit-gradient(linear, 0 0, 0 100%, from(#fdb338), to(#fdb338));
    ...
    .btn_myorder {
        padding: 5px 8px; border: 0; border-radius: 2px; cursor: pointer; background-color: #fdb338; color: #fff;
    }
</style>
</head>
...
<div class="center">
    ...
    <section style="margin-bottom: 10px;">
        <article style="overflow: hidden;">
            <a href="<?php  echo $this->createMobileurl('orderlist', array('from_user' => $from_user, 'storeid' => $storeid), true)?>" class="btn_add btn_myorder" style="color:#fff;">我的订单</a>
    ...
    <section>
        <article>
            <h2>我的菜单
                ...
                <button class="btn_add" onclick="location.href='<?php  echo $this->createMobileUrl('waplist', array('storeid' => $storeid), true)?>'">+加菜</button>
            </h2>
            ...
            <form id="form2" target="hide">
                ...
                <table class="table_book">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <!--<input type="tel" id="tel" name="tel" value="<?php  if(!empty($user['mobile'])) { ?><?php  echo $user['mobile'];?><?php  } else { ?>(必填*)请输入您的手机号码<?php  } ?>" maxlength="13" style="width: 200px;">-->
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <input type="button" onclick="getReceiveMemberCardVCode(this, event,'form2', 'entry_mobile',2);" class="button vcode" value="获取验证码" style="width: 100px;"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <?php  } else { ?>
    <?php  if($store['is_meal'] == 1 || $store['is_delivery'] == 1) { ?>
    <section style="margin-bottom: 20px;">
        <article>
                ...
                <table class="table_book">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <?php  if($store['is_delivery'] == 1) { ?>
                            <span>
                                <input type="radio" name="order_type" value="2"<?php  if($store['is_meal'] == 0) { ?> checked<?php  } ?>>
                                <label>外卖</label>
                            </span>
                            <?php  } ?>
                            <!--<span>-->
                    ...
                    <tr> 
                                 <td style="width: 80px;">用户性别：</td> <td>
                             <div class="group_radio">
                                <span>
                    ...
                    <tr class="out">
                        <td style="width: 80px;">送达时间：</td>
                        <td colspan="2">
                            <select name="meal_time" id="meal_time">
                                <option value="尽快送出">尽快送出</option>
                                <?php  if(is_array($mealtimes)) { foreach($mealtimes as $item) { ?>
                                <option value="<?php  echo $item['begintime'];?>~<?php  echo $item['endtime'];?>"><?php  echo $item['begintime'];?>~<?php  echo $item['endtime'];?></option>
                                <?php  } } ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr class="in" id="tr_tables">
                        ...
                        <td colspan="2">
                            <input type="tel" id="tables" name="tables" value="" maxlength="5" style="width: 100px;">
                        </td>
                    </tr>
                    <tr class="in">
...
function checkItem() {
    ...
    if ($("input:radio[name='sex']:checked").attr("checked") == undefined) { alert("请选择性别！"); return false; }
...
//                "time": $("#sdate").val() + " " + $("#hour").val() + ":" + $("#minute").val(),
            ...
            success: function (data) {
                if (data.message['code'] != 0) {
                    ...
                    //跳转去我的订单
                    window.location.href = "<?php  echo $this->createMobileUrl('orderconfirm', array('storeid' => $storeid, 'from_user' => $from_user), true)?>"+"&orderid="+data.message['orderid'];
                } else {
                    alert(data.message['msg']);
                    //'网络不稳定，请重新尝试!'
                }
