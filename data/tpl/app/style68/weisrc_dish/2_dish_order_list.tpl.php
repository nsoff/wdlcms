...
<body id="page_intelOrder" class="myOrderCon">
    <style>
        ...
        .select_orderType {
            background: url(../addons/weisrc_dish/template/images/btn3.png) no-repeat right 0;
            ...
            <article>
                ...
                <ul id="Ul<?php  echo $items['id'];?>" class="myorder">
                    ...
                    <li>
                        ...
                        <i><?php  echo $item['price'];?>元/<?php  echo $item['unitname'];?></i>
                        <section class="bbox">
        ...
        <section id="des<?php  echo $items['id'];?>" style="margin-bottom: 10px; padding: 0;" class="off">
            ...
            <article>
                ...
                <div style="padding-top: 10px; ">
                    <a href="<?php  echo $this->createMobileUrl('OrderConfirm', array('orderid' => $items['id'], 'storeid' => $item['storeid'], 'from_user' => $from_user), true)?>" class="btn_2">确认订单</a>
                </div>
            </article>
        </section>
        <?php  } } ?>
    ...
    <!--<footer class="footFix footLeft">-->
        <!--<a onclick="location.href='<?php  echo create_url('mobile/module', array('do' => 'waprestlist', 'from_user' => $page_from_user, 'name' => 'weisrc_dish', 'weid' => $weid, 'storeid' => $storeid))?>'">门店列表</a>-->
        <!--<a onclick="location.href='<?php  echo create_url('mobile/module', array('do' => 'waplist', 'from_user' => $page_from_user, 'name' => 'weisrc_dish', 'weid' => $weid, 'storeid' => $storeid))?>'">菜品列表</a>-->
    <!--</footer>-->
