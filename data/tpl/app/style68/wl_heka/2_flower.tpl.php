...
<head>
   ...
   <script>
      ...
      siteurl = "<?php  echo $_W['siteroot']?>app";

      var dataForWeixin = {

         MsgImg: _fromCode + "addons/wl_heka/style/images/flower.jpg",

         TLImg: _fromCode + "addons/wl_heka/style/images/flower.jpg",
...
<style>
   ...
   #card_tip {
      ...
      background-color: rgba(244, 98, 144, 0.7);
...
<div style="display: none;" id="card_loading"><img src="../addons/wl_heka/style/images/card_loading.png"
...
<div style="display: block;" id="card_body">
   ...
   <div id="card_main">
      ...
      <div id="card_top_left"><img src="../addons/wl_heka/style/images/flower_top_left.png"></div>

      <div id="card_top_right"><img src="../addons/wl_heka/style/images/flower_top_right.png"></div>

      <div id="card_bot_left"><img src="../addons/wl_heka/style/images/flower_bot_left.png"></div>

      <div id="card_bot_right"><img src="../addons/wl_heka/style/images/flower_bot_right.png"></div>

      <div><input id="card_title" type="text" value="<?php  echo $show['title'];?>"/></div>
...
<?php  } ?>
      ...
      <div><input id="card_author" type="text" value="<?php  echo $show['author'];?>"/></div>
...
<script>
   ...
   var _wid = 13777, _PUBLIC = "../addons/wl_heka/style/", _cardName = "鲜花贺卡", _cardType = "flower";
