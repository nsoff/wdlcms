...
<head>
   ...
   <script>
      ...
      var dataForWeixin = {
         ...
         MsgImg: _fromCode + "addons/wl_heka/style/images/onlyyou.jpg",

         TLImg: _fromCode + "addons/wl_heka/style/images/onlyyou.jpg",
...
<style>
   ...
   body {
      ...
      background-image: linear-gradient(to top, #fefefe, #ffffff);

      background-image: -webkit-gradient(linear, 0 100%, 0 0, from(#fefefe), to(#ffffff));
...
<div style="display: block;" id="card_body">
   ...
   <div id="card_center"><img src="../addons/wl_heka/style/images/onlyyou_center.png"></div>
   ...
   <?php  if(empty($show['content'])) { ?>我的心里只有你没有他，
...
<script>
   ...
   var _wid = 13777, _PUBLIC = "../addons/wl_heka/style/", _cardName = "示爱贺卡", _cardType = "onlyyou";
   ...
   window.onload = function () {
      ...
      dataForWeixin.callback = function () {
         ...
         _$("<?php  echo $this->createMobileUrl('share', array('card' => $card,'id'=>$_GET['id']));?>", "wid=" + _wid + "&type=card&cid=<?php  echo $show['id'];?>", "");
