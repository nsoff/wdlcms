...
<title>  <?php  echo $flight_setting['title'];?></title>
<body>
	 
<?php  if($userinfo=='0') { ?>
    <div>
        <form id="frm-register" name="ff" class="for">
            <input type="hidden" id="fid" name="fid" value="<?php  echo $_GPC['id'];?>" />
            ...
            <div class="inner-cont">
                ...
                <div class="field-contain">
                    <label for="username" class="input-label">请输入您的名称:</label>
                     <input type="text" name="nickname" id="nickname" class="input-text" value="<?php  echo $user['nickname'];?>">
                </div>
                <div class="field-contain">
                    <label for="phone" class="input-label">请输入您的手机号码:</label>
                     <input type="mobile" name="mobile" id="mobile" class="input-text" value="<?php  echo $user['mobile'];?>">
               ...
               <!-- <div class="field-contain">
                    ...
                    <select id="deptid" name="deptid" class="input-text">
                        ...
                        <?php  if(is_array($depts)) { foreach($depts as $row) { ?>
                        <option value="<?php  echo $row['id'];?>" <?php  if($row['id']==$user['deptid']) { ?> selected="selected"<?php  } ?>><?php  echo $row['deptName'];?>
                        </option>
                        <?php  } } ?>
                    </select>
