...
<title><?php  if(isset($title)) $_W['page']['title'] = $title?><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>微动力 - 微信公众平台开源管理系统-wdlcms.com<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
<meta name="keywords" content="<?php  if(empty($_W['page']['copyright']['keywords'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>微动力,微信,微信公众平台<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['keywords'];?><?php  } ?>" />
<meta name="description" content="<?php  if(empty($_W['page']['copyright']['description'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>微信公众平台自助引擎，简称微动力，微动力是一款开源的微信公众平台管理系统。<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['description'];?><?php  } ?>" />
...
<ul >
				...
				<li onClick="navmove('#about','3')"><a href="http://bbs.wdlcms.com/plugin.php?id=qmx8_buy_usergroup:vip" title="价格体系">程序购买</a></li>
                <li onClick="navmove('#news','4')"><a href="http://bbs.wdlcms.com/forum.php" title="程序下载">程序下载</a></li>
...
<div class="infocus">
	<div class="focus_pic">
		...
		<li><a href="/"><img src="./resource/weidongli/images/pic04.jpg" width="1920" height="612" alt="微动力新时代"></a></li>
		</ul>
	</div>
...
<div class="footbg">
<div class="foot">
<p class="fl">Powered by <strong><a href="/" target="_blank">wdlcms.com</a></strong> <em>WDL2.0918</em>&nbsp--&copy; 2001-2014 <a href="/" target="_blank"><a href="/" target="_blank">微动力</a></a></p>
<p class="fr"><a href="/" title="">网站首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="archiver/" >Archiver</a>
&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://bbs.wdlcms.com/qmx8_buy_usergroup-vip.html" >申请入住</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://bbs.wdlcms.com/forum-2-1.html" >软件下载</a>&nbsp;&nbsp;|&nbsp;&nbsp;
<a href="http://wpa.qq.com/msgrd?v=3&uin=2740380951&site=qq&menu=yes" target="_blank">接口定制</a>&nbsp;|&nbsp;
				...
				<a href="http://bbs.wdlcms.com" target="_blank">微站论坛</a>
