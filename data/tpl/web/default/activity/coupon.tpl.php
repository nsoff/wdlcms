		...
		<div class="panel panel-default" id="step1">
			...
			<div class="panel-body">
				<div class="form-group">
					<label class="col-sm-9 col-sm-3 col-md-2 control-label"><span class="text-danger"></span> 可用模块</label>
				...
				<div class="form-group">
					<label class="col-sm-9 col-sm-3 col-md-2 control-label"><span class="text-danger">*</span> 满多少钱可打折</label>
					<div class="col-sm-9 col-xs-12">
		...
		<table class="table table-hover">
			<thead class="navbar-inner">
				<tr>
					...
					<th style="width:100px;">可用次数</th>
					<th style="width:60px;">总量</th>
					<th style="width:100px;">已领取</th>
