...
<div class="clearfix">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					...
					<ul class="list-unstyled">
					<script type="text/javascript" src="http://bbs.wdlcms.com/api.php?mod=js&bid=23"></script>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i> 温馨提示：普通论坛会员只可以免费更新微动力程序框架；商业会员及以上才能享受功能/模板的更新服务！
	</div>
	<form action="" method="post" class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; 系统当前版本: WDL<?php  echo IMS_VERSION?></p>
				<?php  if($upgrade['version'] != IMS_VERSION) { ?>
				<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; 存在的新版本: WDL<?php  echo $upgrade['version'];?></p>
				<?php  } ?>
