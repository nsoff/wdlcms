		...
		<table class="table table-hover" style="position:relative">
			...
			<tbody>
				...
				<td><?php  echo $count;?></td>
                                                ...
                                                <td><?php  if($row['status']==0) { ?><span class="label label-default">未领取</span><?php  } else if($row['status']==1) { ?><span class="label label-success">已兑奖</span><?php  } else { ?><span class="label label-red">已兑奖</span><?php  } ?></td>
                                                <td><?php  echo $row['mobile'];?></td>
                                                <td><?php  echo $row['nickname'];?></td>
                                                <td><?php  echo $row['from_user'];?></td>
                                                <td><?php  echo date('Y/m/d H:i',$row['createtime']);?></td>
                                                <td><?php  if($row['consumetime'] == 0) { ?>未兑奖<?php  } else { ?><?php  echo date('Y/m/d H:i',$row['consumetime']);?><?php  } ?></td>
                                                <td>
