...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-2 col-xs-12">
                <label class="radio-inline">
                    <input type="radio" name="votelimit" value="0" <?php  if($reply['votelimit'] == 0) { ?>checked="checked"<?php  } ?>/>时间限制
                </label>
            </div>
            <div class="col-sm-3">
                <?php  echo tpl_form_field_daterange('datelimit', array('starttime'=>date('Y-m-dH:i',$reply['starttime']),'endtime'=>date('Y-m-d H:i',$reply['endtime'])),array('time'=>true))?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <label class="radio-inline">
                    <input type="radio" name="votelimit" value="1" <?php  if($reply['votelimit'] == 1) { ?>
                    checked="checked"<?php  } ?>/>人数限制
                </label>
            </div>
            <div class="col-sm-3">
                <div class="input-group" style='float:left'>
                    <span class="input-group-addon">共</span>
                    <input type="text" class="form-control" name="votetotal" id="votetotal" value="<?php  echo $reply['votetotal'];?>"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3 ">
                <div class="input-group">
                    <span class="input-group-addon">共</span>
                    <input type="text" class="form-control" name="votetimes" id="votetimes" value="<?php  echo $reply['votetimes'];?>"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <label class="radio-inline">
                    <input type="radio" name="votetype" value="0" <?php  if($reply['votetype'] == 0) { ?>checked="true" <?php  } ?>>单选
                </label>&nbsp;&nbsp;
                <label class="radio-inline">
                    <input type="radio" name="votetype" value="1" <?php  if($reply['votetype'] == 1) { ?>checked="true" <?php  } ?>>多选
                </label>&nbsp;&nbsp;
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <label class="radio-inline">
                    <input type="radio" name="isimg" onclick="changeTo('text')" id='isimg' value="0" <?php  if($reply['isimg'] == 0) { ?> checked="true" <?php  } ?>>文本
                </label>&nbsp;&nbsp;
                <label class="radio-inline">
                    <input type="radio" name="isimg" onclick="changeTo('image')" value="1" <?php  if($reply['isimg'] == 1) { ?> checked="true" <?php  } ?>>图片
                </label>&nbsp;&nbsp;
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12" id="re-items">
                ...
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('item', TEMPLATE_INCLUDEPATH)) : (include template('item', TEMPLATE_INCLUDEPATH));?>
                <?php  } } ?>
            </div>
        </div>
        <div class="form-group">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <textarea style="height:60px;" id='share_txt' name="share_txt" class="form-control richtext" cols="60"><?php  echo $reply['share_txt'];?></textarea>
