...
.module .media-object{display:inline-block; float:left; margin-right:20px;margin-left: 10px; width:40px; height:40px; overflow:hidden;border-radius: 50%;}
.module .media-heading{font-weight:normal; font-size:13px;}
...
<div class="clearfix">
	<?php  if($do == 'installed') { ?>
	<div class="form">
		<h5 class="page-header" style="margin: 20px 0 10px;">已安装的模块</h5>
	</div>
			...
			<div class="media">
				<div class="pull-right" style="width:230px;">
					<div class="module-set">
						...
						<a href="http://addons.wdlcms.com/web/index.php?c=store&a=author&do=application&id={{m.id}}" target="_blank">查看详情</a>
						&nbsp;
					</div>
				</div>
				<img class="media-object img-rounded gray" ng-src="http://addons.wdlcms.com/resource/attachment/{{m.thumb}}" onerror="this.src='../web/resource/images/nopic-small.jpg'">
				<div class="media-body">
					<h4 class="media-heading">
