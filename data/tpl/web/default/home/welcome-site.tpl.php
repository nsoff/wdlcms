                ...
                <li class="xn-openable active">
                    ...
                    <ul id="frame-<?php  echo $k;?>" class="panel-collapse collapse in">
                        <li>
                            ...
                            <a class="list-group-item1<?php  echo $link['active'];?>" onclick="window.location.href = '<?php  echo $link['url'];?>';" style="cursor:pointer;">
                                <?php  echo $link['title'];?>
                            </a></li>
                        <?php  } else { ?>
                        <li>  <a class="list-group-item1<?php  echo $link['active'];?>" href="<?php  echo $link['url'];?>" ><?php  echo $link['title'];?></a>
                            <?php  } ?>
                            <?php  } } ?></li>
                    </ul>
