	...
	<form action="" method="post" id="form1" >
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					<td><input type="text" class="form-control" name="orderlist[<?php  echo $item['groupid'];?>]" value="<?php  echo $item['orderlist'];?>"></td>
					<td style="vertical-align:middle;">
						<input type="input" name="title[<?php  echo $item['groupid'];?>]" class="form-control" value="<?php  echo $item['title'];?>" />
					</td>
					<td style="vertical-align:middle;">
