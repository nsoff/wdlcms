...
<div class="clearfix">
	<div class="alert alert-danger" style="margin-bottom:10px;color: #33414e;">
		使用微信群发,首先确定您的公众号为"认证服务号"或"认证订阅号"。确定后,在 <a href="<?php  echo url('mc/fangroup')?>" style="color: #7E0606;font-weight:bold;">粉丝分组</a> 拉取您的粉丝分组。
	</div>
