	...
	<form action="" method="post" class="form-horizontal form"
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">第三张幻灯片</label>
					<div class="col-sm-9 col-xs-12">
		...
		<table class="table table-hover">
			<thead class="navbar-inner">
				<tr>
					...
					<th style="width: 180px;">链接地址</th>
					<th style="width: 100px;">联系电话</th>
					<th style="width: 100px;">浏览次数</th>

					<th style="text-align: center; min-width: 300px;">操作</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<a
						...
						title="说明项" class="btn btn-small">用户留言<i class="glyphicon glyphicon-heart"></i></a>
					
					<a
						href="<?php  echo $this->createWebUrl('note', array( 'bid' => $item['id']))?>"
						title="说明项" class="btn btn-small"><i class="glyphicon glyphicon-book"></i>说明项</a>
						<a
