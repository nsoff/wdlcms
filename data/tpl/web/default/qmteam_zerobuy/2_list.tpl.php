		...
		<div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="inventory" class="form-control" value="<?php  echo $info['inventory'];?>" />
                    </div>
                </div>
		        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="info" class="form-control richtext" cols="70"><?php  echo $info['info'];?></textarea>
                    </div>
                </div>
               <div class="form-group">
                	<label class="col-xs-12 col-sm-3 col-md-2 control-label">商品状态</label>
                    <div class="col-sm-9">
					    <input type="radio" name="status" value="1" <?php  if($info['status']==1) { ?>checked<?php  } ?> />
                    </div>
                </div>
            </div>
        </div>
