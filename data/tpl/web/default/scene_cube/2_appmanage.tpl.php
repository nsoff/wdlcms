                ...
                <form action="" method="post" class="form-horizontal form-validate">
                    <div class="box-content">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php  echo $_W['account']['name'];?>(<?php  echo $_W['weid'];?>)
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="listorder" class="control-label">场景信息：</label>
                            <div class="controls">
                                <?php  echo $app['title'];?>(<?php  echo $app['iden'];?>)
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group clearfix">
                            ...
                            <div class="controls">
                                <label class="radio inline"><input type="radio" value="1" name="status" <?php  if($item['status']==1) { ?>checked="checked"<?php  } ?>>是</label>
                                <label class="radio inline"><input type="radio" value="0" name="status"<?php  if($item['status']==0) { ?>checked="checked"<?php  } ?> >否</label>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="appnums" class="control-label">授权数量：</label>
                            <div class="controls">
                                <input type="text" id="appnums" name="appnums" value="<?php  echo $item['appnums'];?>" class="input-mini valid" data-rule-required="true" data-rule-number="true">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="box-title">
                    <div class="span12">
                        <h3><i class="icon-edit"></i><?php  if($item['title']) { ?>修改<?php  } else { ?>新增<?php  } ?>微场景应用</h3>
                    </div>
                </div>
                <form action="" method="post" class="form-horizontal form-validate">
                    <div class="box-content">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="listorder" name="listorder" value="<?php  echo $item['listorder'];?>" class="input-mini valid" data-rule-required="true" data-rule-number="true">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="price" name="price" value="<?php  echo $item['price'];?>" class="input valid" data-rule-required="true" data-rule-number="true">
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="iden" class="control-label">微场景标识：</label>
                            <div class="controls">
                                <input type="text" name="iden" id="iden" class="input-medium" value="<?php  echo $item['iden'];?>" data-rule-required="true" data-rule-maxlength="25"><span class="maroon">*</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="author" id="author" value="<?php  echo $item['author'];?>" class="input-medium" data-rule-required="true" data-rule-maxlength="25"><span class="maroon">*</span>
                                <span class="help-inline">不能超过25个字符</span>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="series" id="series" value="<?php  echo $item['series'];?>" class="input-medium" data-rule-required="true" data-rule-maxlength="25"><span class="maroon">*</span>
                                <span class="help-inline">不能超过25个字符</span>
                            </div>
                        </div>
                        <div class="control-group clearfix">
                            ...
                            <div class="controls">
                                <label class="radio inline"><input type="radio" value="1" name="isshow" <?php  if($item['isshow']==1) { ?>checked="checked"<?php  } ?>>是</label>
                                <label class="radio inline"><input type="radio" value="0" name="isshow"<?php  if($item['isshow']==0) { ?>checked="checked"<?php  } ?> >否</label>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary">保存</button>
