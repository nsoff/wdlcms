    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <button class="btn btn-info" type="button" onclick="$('#modal-module-menus').modal('show');">选择要展示的场景</button>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">场景信息</label>
            <div class="col-sm-9 col-xs-12">
                <div id="entry-preview" class="alert alert-info reply-news-list reply-news-list-first"
                     style="width:400px;height:200px;<?php  if(!$activity) { ?>display:none;<?php  } ?>">
                    <div class="reply-news-list-cover"><img src="<?php  echo $activity['reply_thumb'];?>" alt=""></div>
                    <div class="reply-news-list-detail" style="width:370px;">
                        <div class="title"><?php  echo $activity['reply_title'];?></div>
                        <div class="content"><?php  echo $activity['reply_description'];?></div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 control-label">场景搜索</label>
                    <div class="col-sm-10">
