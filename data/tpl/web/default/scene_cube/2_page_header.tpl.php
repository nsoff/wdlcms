...
<style type="text/css">
    ...
    .input-append {word-spacing: -6px;}
    .input-append button#positioning{padding: 7px 8px; word-spacing: 0;}
...
<script type="text/javascript" src="../addons/scene_cube/style/src/app/resource.js?v=2014-05-21"></script>