...
<div class="panel panel-warning">
	<div class="panel-body">
		当前使用的风格为：<?php  echo $style['name'];?>，模板文件为：<?php  echo $template['title'];?>（/app/themes/<?php  echo $template['name'];?>）。<?php  if(!empty($template['sections'])) { ?>此模板提供<?php  echo $template['sections'];?>个导航位置，您添加导航可以指定显示显示位置<?php  } else { ?>此模板未提供导航位置功能<?php  } ?>
	</div>
</div>
<?php  } ?>
