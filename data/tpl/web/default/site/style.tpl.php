...
<div class='alert alert-warning' style='font-size:14px'>
        微站栏目不显示？可能没有设置‘导航显示位置’： <a href='http://bbs.wdlcms.com/forum.php?mod=viewthread&tid=1622&page=1&extra=#pid10746' target='_blank'>http://bbs.wdlcms.com/forum.php?mod=viewthread&tid=1622&page=1&extra=#pid10746</a>
    </div>
	<div class="panel panel-default">
...
<script type="text/javascript">
	...
	function preview(styleid) {
		require(['jquery', 'util'], function($, u){
			...
			dialog.find('.modal-dialog').css({'width': '330px'});
