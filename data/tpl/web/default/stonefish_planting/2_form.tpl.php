...
<div class="panel panel-default">
	...
	<div class="row-fluid">
    	<div class="span8 control-group">
			...
			<a class="btn btn-default" href="<?php  echo $this->createWebUrl('awardlist',array('rid' => $rid));?>">中奖名单</a>
			<a class="btn btn-default" href="<?php  echo $this->createWebUrl('awarddui',array('rid' => $rid));?>">兑奖统计</a>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">        
		<div class="form-group" id="award_times">
 			<label class="col-xs-12 col-sm-3 col-md-2 control-label">选择种子</label>
            <div class="col-sm-9 col-xs-6">
               	<select name="seedid" class="form-control">
					<?php  if(is_array($seed)) { foreach($seed as $seedid) { ?>
					<option value="<?php  echo $seedid['id'];?>" <?php  if($seedid['id'] == $reply['seedid']) { ?>selected<?php  } ?>><?php  echo $seedid['seedname'];?></option>
					<?php  } } ?>
				</select>
            </div>
        </div>
		<div class="form-group" id="award_times">
 			<label class="col-xs-12 col-sm-3 col-md-2 control-label">抽奖开始级别</label>
            <div class="col-sm-9 col-xs-6">
               	<div class="input-group">
					<span class="input-group-addon">植物生长到</span>
					<select name="award_times" class="form-control">
						<option value="2" <?php  if(2 == $reply['award_times']) { ?>selected<?php  } ?>>发芽期7次</option>
						<option value="3" <?php  if(3 == $reply['award_times']) { ?>selected<?php  } ?>>生长期6次</option>
						<option value="4" <?php  if(4 == $reply['award_times']) { ?>selected<?php  } ?>>发枝期5次</option>
						<option value="5" <?php  if(5 == $reply['award_times']) { ?>selected<?php  } ?>>繁荣期4次</option>
						<option value="6" <?php  if(6 == $reply['award_times']) { ?>selected<?php  } ?>>开花期3次</option>
						<option value="7" <?php  if(7 == $reply['award_times']) { ?>selected<?php  } ?>>结果期2次</option>
						<option value="8" <?php  if(8 == $reply['award_times']) { ?>selected<?php  } ?>>成熟期1次</option>
					</select>
					<span class="input-group-addon">抽奖机会!</span>
				</div>
            </div>
        </div>
		<div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">摇奖说明</label>
            <div class="col-sm-9 col-xs-12">
               	<textarea style="height:60px;" id='ticket_information' name="ticket_information" class="form-control" cols="60"><?php  echo $reply['ticket_information'];?></textarea>
            </div>
        </div>
		<div class="form-group">
 			<label class="col-xs-12 col-sm-3 col-md-2 control-label">兑奖类型</label>
            <div class="col-sm-9 col-xs-6">
               	<div class="input-group">
					<label for="tickettype0" class="radio-inline"><input type="radio" name="tickettype" value="1" id="tickettype0" <?php  if(empty($reply) || $reply['tickettype'] == 1) { ?>checked="true"<?php  } ?>/> 后台兑奖</label>&nbsp;&nbsp;&nbsp;
					<label for="tickettype1" class="radio-inline"><input type="radio" name="tickettype" value="2" id="tickettype1" <?php  if($reply['tickettype'] == 2) { ?>checked="true"<?php  } ?>/> 店员兑奖</label>&nbsp;&nbsp;&nbsp;
					<?php  if($stonefish_branch) { ?><label for="tickettype2" class="radio-inline"><input type="radio" name="tickettype" value="3" id="tickettype2" <?php  if($reply['tickettype'] == 3) { ?>checked="true"<?php  } ?>/> 商家网点兑奖</label><?php  } ?>
				</div>				
            </div>
        </div>
		<div class="form-group">
 			<label class="col-xs-12 col-sm-3 col-md-2 control-label">领取种子选项</label>
            <div class="col-sm-9 col-xs-6">
               	<div class="input-group">
		...
		<div class="form-group" id="credit"<?php  if(!empty($reply) && $reply['opportunity'] == 2) { ?> style="display:block"<?php  } else { ?> style="display:none"<?php  } ?>>
            ...
            <div class="col-sm-9 col-xs-6">
               	<div class="input-group">
					...
					<span class="input-group-addon">购买种子</span>
				</div>
            </div>
        </div>
		<div class="form-group">
...
<div class="panel panel-default" id="award">
	...
	<div class="panel-body">
		<?php  if($prize) { ?>
			...
			<div class="form-group">
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">邀请级别</label>
                <div class="col-sm-9">
                    <div class="input-group">
                        <span class="input-group-addon">植物生长级别为</span>
						<select name="sharenum[<?php  echo $item['id'];?>]" class="form-control">
						    <option value="2" <?php  if(2 == $item['sharenum']) { ?>selected<?php  } ?>>发芽期</option>
							<option value="3" <?php  if(3 == $item['sharenum']) { ?>selected<?php  } ?>>生长期</option>
							<option value="4" <?php  if(4 == $item['sharenum']) { ?>selected<?php  } ?>>发枝期</option>
							<option value="5" <?php  if(5 == $item['sharenum']) { ?>selected<?php  } ?>>繁荣期</option>
							<option value="6" <?php  if(6 == $item['sharenum']) { ?>selected<?php  } ?>>开花期</option>
							<option value="7" <?php  if(7 == $item['sharenum']) { ?>selected<?php  } ?>>结果期</option>
							<option value="8" <?php  if(8 == $item['sharenum']) { ?>selected<?php  } ?>>成熟期</option>							
					    </select>
						<span class="input-group-addon">时可参与摇一摇抽奖</span>
                    </div>					
                </div>				
            </div>
            <div class="form-group">
		...
		<div id="jiangpin" style="display: none">
			...
			<div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <span class="input-group-addon">植物生长级别为</span>
						<select name="sharenum_new[]" class="form-control">
						    <option value="2">发芽期</option>
							<option value="3">生长期</option>
							<option value="4">发枝期</option>
							<option value="5">繁荣期</option>
							<option value="6">开花期</option>
							<option value="7">结果期</option>
							<option value="8">成熟期</option>							
					    </select>
						<span class="input-group-addon">时可参与摇一摇抽奖</span>
                    </div>					
                </div>				
