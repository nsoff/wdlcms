...
<div class="main">
	<ul class="nav nav-tabs">
		<li<?php  if($_GPC['do'] == 'manage' || $_GPC['do'] == '' ) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage');?>">种植乐园管理</a></li>
<li<?php  if($_GPC['do'] == 'post') { ?> class="active"<?php  } ?>><a href="<?php  echo url('platform/reply/post',array('m'=>'stonefish_planting'));?>">添加种植乐园规则</a></li>
	</ul> 
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<?php  echo $this->createWebUrl('awardlist',array('rid'=>$row['id']))?>" class="btn  btn-default" data-toggle="tooltip" data-placement="top" title="中奖记录名单"><i class="fa fa-gift"></i> 中奖</a>
						<a href="<?php  echo $this->createWebUrl('awarddui',array('rid'=>$row['id']))?>" class="btn  btn-default" data-toggle="tooltip" data-placement="top" title="兑奖统计"><i class="fa fa-bar-chart-o"></i> 统计</a>
                        ...
                        <a class="btn btn-default" data-toggle="tooltip" data-placement="top" href="<?php  echo url('platform/reply/post',array('m'=>'stonefish_planting','rid'=>$row['id']));?>" title="编辑"><i class="fa fa-edit"></i></a>
                        <?php  if($row['isshow']==0) { ?>
