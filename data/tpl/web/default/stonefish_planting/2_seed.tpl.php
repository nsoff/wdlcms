		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php  echo $row['seed01'];?> </td>
					<td><?php  echo $row['seed02'];?> </td>
					<td><?php  echo $row['seed03'];?> </td>
					<td><?php  echo $row['seed04'];?> </td>
					<td><?php  echo $row['seed05'];?> </td>
					<td><?php  echo $row['seed06'];?> </td>
					<td><?php  echo $row['seed07'];?> </td>
					<td><?php  echo $row['seed08'];?> </td>
					<td>
