    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                  <label class=" radio-inline">
                        <input type="radio" name="type" value="0" <?php  if($reply['type'] == 0) { ?> checked="checked"<?php  } ?>/>
                               集分
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="type" value="1" <?php  if($reply['type'] == 1) { ?> checked="checked"<?php  } ?>/>
                               集钱
                    </label>
                ...
                <div class="alert alert-block alert-new" style='width:500px;'>
                        <table class='table'>
                            ...
                            <tbody id="award-items">
                                <?php  if(is_array($awards)) { foreach($awards as $award) { ?>
                                <tr class='award_item'>
                                    <td><input  name="award_point[]" type="text" class="form-control span2" value="<?php  echo $award['point'];?>"  maxlength="50"/></td>
                                    <td><input  name="award_name[]" type="text" class="form-control span2" value="<?php  echo $award['name'];?>" maxlength="10"  style="width:100px;"/></td>
                                    <td><input  name="award_num[]" type="text" class="form-control span2" value="<?php  echo $award['num'];?>"  maxlength="50"/></td>
                                    <td>
                                        <input  name="award_id[]" type="hidden" value="<?php  echo $award['id'];?>" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                  ...
                  <input  name="start" type="text" class="form-control input-small " value="<?php  echo $reply['start'];?>"  maxlength="50" style='width:100px;'/> 
                  到
                          <input  name="end" type="text" class="form-control input-small" value="<?php  echo $reply['end'];?>"  maxlength="50"  style='width:100px;'/> 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9" style="margin-top:5px;">    
                 <div class="input-group col-sm-4" style="float:left">
                        ...
                        <input type="text" class="form-control span1" name="self_times" value="<?php  echo $reply['self_times'];?>" />
                        <span class="input-group-addon">次</span>
                    </div>
                <div class="input-group col-sm-4" style="float:left">
                        <span class="input-group-addon">每天被助力</span>
                        <input type="text" class="form-control span1" name="self_day_times" value="<?php  echo $reply['self_day_times'];?>" />
                        <span class="input-group-addon">次</span>
                </div>
            </div>
        </div>
         <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
              <div class="col-sm-9 col-xs-12" style="margin-top:5px;">    
                  <div class="input-group col-sm-4" style="float:left">
                        ...
                        <input type="text" class="form-control span1" name="other_times" value="<?php  echo $reply['other_times'];?>" />
                        <span class="input-group-addon">次</span>
                    </div>
                <div class="input-group col-sm-4" style="float:left">
                        <span class="input-group-addon">每天助力别人</span>
                        <input type="text" class="form-control span1" name="other_day_times" value="<?php  echo $reply['other_day_times'];?>" />
                        <span class="input-group-addon">次</span>
                </div>
              </div>
         </div>
            ...
            <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                 ...
                 <div class="input-group  col-sm-4" style="float:left">
                        ...
                        <input type="text" class="form-control span1" name="other_one_times" value="<?php  echo $reply['other_one_times'];?>" />
                        <span class="input-group-addon">次</span>
                    </div>
                <div class="input-group   col-sm-4" style="float:left">
                        <span class="input-group-addon">每天助力相同用户</span>
                        <input type="text" class="form-control span1" name="other_one_day_times" value="<?php  echo $reply['other_one_day_times'];?>" />
                        <span class="input-group-addon">次</span>
                </div>
                  </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                    <input type="text" id="tel_rename" class="form-control span7" placeholder="" name="tel_rename" value="<?php  if(empty($reply['tel_rename'])) { ?>手机号<?php  } else { ?><?php  echo $reply['tel_rename'];?><?php  } ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                   <input type="text" id="tips" class="form-control span7" placeholder="" name="tips" value="<?php  if(empty($reply['tips'])) { ?>奖品有限，快快参加!<?php  } else { ?><?php  echo $reply['tips'];?><?php  } ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                  <input type="text" id="tel_rename" class="form-control span7" placeholder="" name="info_tips" value="<?php  if(empty($reply['info_tips'])) { ?>已经获得了 [P] [U] !<?php  } else { ?><?php  echo $reply['info_tips'];?><?php  } ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                 <input type="text" id="unit" class="form-control span7" placeholder="" name="unit" value="<?php  if(empty($reply['unit'])) { ?>分<?php  } else { ?><?php  echo $reply['unit'];?><?php  } ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                  <input type="text" id="tel_rename" class="form-control span7" placeholder="" name="help_tips" value="<?php  if(empty($reply['help_tips'])) { ?>给 TA 助力<?php  } else { ?><?php  echo $reply['help_tips'];?><?php  } ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                   <input type="text" id="tel_rename" class="form-control span7" placeholder="" name="join_tips" value="<?php  if(empty($reply['join_tips'])) { ?>我要参加活动<?php  } else { ?><?php  echo $reply['join_tips'];?><?php  } ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                  <input type="text" id="invite_tips" class="form-control span7" placeholder="" name="invite_tips" value="<?php  if(empty($reply['invite_tips'])) { ?>邀请好友助力<?php  } else { ?><?php  echo $reply['invite_tips'];?><?php  } ?>">
            ...
            <div class="col-sm-9 col-xs-12">
                  <input type="text" id="rank_tips" class="form-control span7" placeholder="" name="rank_tips" value="<?php  if(empty($reply['rank_tips'])) { ?>好友排名<?php  } else { ?><?php  echo $reply['rank_tips'];?><?php  } ?>">
            ...
            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span>排名数</label>
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control span1" name="rank_num" value="<?php  echo $reply['rank_num'];?>" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                 <textarea style="height:200px; width:100%;" id='joincontent' class="form-control span7 richtext" name="joincontent" cols="70"><?php  echo $reply['joincontent'];?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                     <input type="text" id="share_url" class="form-control span7" placeholder="" name="share_url" value="<?php  echo $reply['share_url'];?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <textarea style="height:200px; width:100%;" id='content' class="form-control span7 richtext" name="content" cols="70"><?php  echo $reply['content'];?></textarea>
            </div>
        </div>
            <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span>活动结束说明</label>
            <div class="col-sm-9 col-xs-12">
                  <textarea style="height:200px; width:100%;" id='overcontent' class="form-control span7 richtext" name="overcontent" cols="70"><?php  echo $reply['overcontent'];?></textarea>
            ...
            <div class="col-sm-9 col-xs-12">
                   <label class="radio-inline">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="show_num" value="0" <?php  if($reply['show_num'] == 0) { ?> checked="checked"<?php  } ?>/>
                               不显示
                    </label>
            </div>
        </div>
            ...
            <div class="col-sm-9 col-xs-12">
                   <label class="radio-inline">
                        <input type="radio" name="show_rank" value="1" <?php  if($reply['show_rank'] == 1) { ?> checked="checked"<?php  } ?>/>
                               显示
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="show_rank" value="0" <?php  if($reply['show_rank'] == 0) { ?> checked="checked"<?php  } ?>/>
                               不显示
                    </label>
            </div>
        </div>
            ...
            <div class="col-sm-9 col-xs-12">
                   <label class="radio-inline">
                        <input type="radio" name="show_helps" value="1" <?php  if($reply['show_helps'] == 1) { ?> checked="checked"<?php  } ?>/>
                               显示
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="show_helps" value="0" <?php  if($reply['show_helps'] == 0) { ?> checked="checked"<?php  } ?>/>
                               不显示
                    </label>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                 <textarea style="height:60px;" name="share_desc" class="form-control span7" cols="60"><?php  echo $reply['share_desc'];?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">分享说明</label>
            <div class="col-sm-9 col-xs-12">
             <textarea style="height:200px; width:100%;" id='share_txt' class="form-control span7 richtext-clone" name="share_txt" cols="70"><?php  echo $reply['share_txt'];?></textarea>
