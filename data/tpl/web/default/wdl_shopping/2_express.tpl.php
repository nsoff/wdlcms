...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('express',array('op' =>'display'))?>">物流方式</a></li>
	<li<?php  if($operation == 'post' && empty($express['id'])) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('express',array('op' =>'post'))?>">添加物流方式</a></li>
	<?php  if(!empty($express['id']) && $operation== 'post') { ?> <li class="active"><a href="<?php  echo $this->createWebUrl('express',array('op' =>'post','id'=>$express['id']))?>">编辑物流方式</a></li> <?php  } ?>
</ul>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:left;">
						<a href="<?php  echo $this->createWebUrl('express', array('op' => 'post', 'id' => $item['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="修改"><i class="fa fa-pencil"></i></a>
						<a href="<?php  echo $this->createWebUrl('express', array('op' => 'delete', 'id' => $item['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="displayorder" class="form-control" value="<?php  echo $express['displayorder'];?>" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="express_area" class="form-control" value="<?php  echo $express['express_area'];?>" />
					</div>
				</div>
			</div>
		</div>
