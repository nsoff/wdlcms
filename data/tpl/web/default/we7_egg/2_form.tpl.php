...
<div class="panel panel-default">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
        	<textarea style="height:60px;" id='rule' name="rule" class="form-control" cols="60"><?php  echo $reply['rule'];?></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3 col-xs-12">
        	<div class="input-group">
                ...
                <input type="text" value="<?php  echo $reply['periodlottery'];?>" class="form-control" name="periodlottery" placeholder="填天数">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12"><input type="text" value="<?php  echo $reply['misscredit'];?>" class="form-control" name="misscredit">
