...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div  id="new-reply" class="row <?php  if(empty($activity)) { ?>hide<?php  } ?>">
                    ...
                    <div class="alert">
                        <div style="position:relative">
                            <div class="reply-news-list-cover">
                                <img src="<?php  echo $_W['attachurl'];?><?php  echo $activity['thumb'];?>"/>
                            </div>
                            <div class="reply-news-list-detail">
                                <span class="help-block title"><strong><?php  echo $activity['title'];?></strong></span>
            ...
            <div class="modal-body" >  
                <div class="row">
                    <div class="input-group">
                        <input type="text" class="form-control" name="keyword" value="" id="search-kwd" placeholder="请输入预约名称" />
...
<script type="text/javascript">
	...
	function select_entry(o) {
		$(".close").click();
		$('.reply-news-list-cover img').attr('src', '<?php  echo $_W['attachurl'];?>' + o.thumb);
