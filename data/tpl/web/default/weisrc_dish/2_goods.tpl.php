...
<div class="main">
        ...
        <div class="panel-body">
            <form action="./index.php" method="get" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label" style="width: 100px;">菜品分类</label>
                    <div class="col-sm-2 col-lg-2">
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <a class="btn btn-primary" href="<?php  echo $this->createWebUrl('goods', array('op' => 'post', 'storeid' => $storeid))?>"><i class="icon-plus"></i> 添加菜品</a>
        ...
        <table class="table table-hover">
			<thead class="navbar-inner">
				<tr>
					...
					<th style="width:14%">菜品名称</th>
                    <th style="width:8%;">特价</th>
			...
			<tbody>
				...
				<tr>
					...
					<td>
                        <img src="<?php  echo $_W['attachurl'];?><?php  echo $item['thumb'];?>" width="50" onerror="this.src='./resource/images/nopic.jpg';" style="border-radius: 3px;" /><br/>
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">菜品分类</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">菜品图片</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">特价菜品</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">特价价格</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">菜品原价</label>
                    <div class="col-sm-9">
                        <div class="input-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">菜品描述</label>
                    <div class="col-sm-9">
