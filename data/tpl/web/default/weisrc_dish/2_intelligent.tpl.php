	...
	<input type="hidden" name="parentid" value="<?php  echo $parent['id'];?>" />
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">菜品选择</label>
                    <div class="col-sm-9">
...
<div class="main">
    <form action="" method="post" class="form-horizontal form" onsubmit="return formcheck(this)"  enctype="multipart/form-data">
        <a class="btn btn-primary" href="<?php  echo $this->createWebUrl('intelligent', array('op' => 'post', 'storeid' => $storeid))?>"><i class="icon-plus"></i> 添加智能选菜</a>
    ...
    <div class="panel panel-default">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th style="width:72%;text-align: left;">菜品</th>
