<?php defined('IN_IA') or exit('Access Denied');?><!--360全景-->
<!--作者:微赞-->
<!--qq : 15595755-->
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style="color:red">*</span> VIEW</label>
            <div class="col-sm-9 col-xs-12">
                <a class="btn btn-default btn-sm" href="<?php  echo $this->createMobileurl('view', array('op' => 'view', 'rid' => $reply['rid']), true)?>" target="_blank"><i class="fa fa-camera-retro"></i> 预览</a>
            </div>
        </div>
        <?php  } ?>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <input type="text" value="<?php  echo $reply['music'];?>" class="form-control" name="music">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <select id="casetype" name="casetype" onchange="return changeType(this.value);" class="location form-control">
                    <option value=-1 <?php  if(empty($reply['type'])) { ?>selected<?php  } ?>>自定义</option>
                    <option value=1 <?php  if($reply['type']==1) { ?>selected<?php  } ?>>案例1——巴西里约热内卢</option>
                    <option value=2 <?php  if($reply['type']==2) { ?>selected<?php  } ?>>案例2——曼德拉的房间</option>
                    <option value=3 <?php  if($reply['type']==3) { ?>selected<?php  } ?>>案例3——李嘉诚办公室</option>
                </select>
                <br/>
            </div>
        </div>
...
<div class="panel panel-default" id="piclist" style="<?php  if($reply['type']!=-1) { ?>display:none;<?php  } ?>">
    <div class="panel-heading">
        360全景自定义图片
    </div>
    <div class="panel-body">
